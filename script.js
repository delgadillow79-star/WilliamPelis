       // Espera a que el contenido del DOM esté completamente cargado
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const navBuscar = document.querySelector('#nav-buscar');
            const inicioSection = document.querySelector('#inicio-section');
            const buscarSection = document.querySelector('#buscar-section');
            const movieGridInicio = document.querySelector('#movie-grid-inicio');
            const movieGridBuscar = document.querySelector('#movie-grid-buscar');
            ...
            const displayMovies = (movieList, container) => {
                ...
                movieList.forEach(movie => {
                    ...
                    // Captura el clic en la tarjeta de la película
            ...
            const filterAndDisplay = () => {
                ...
                console.log('Función filterAndDisplay ejecutada. Término de búsqueda:', searchTerm);
